...
var animal: [String:String] = ["Lion":"King","Tiger":"Pride","Cheetah":"Speed","Elephant":"Elegant","Fox":"Cunning","Dog":"Loyal","Cow":"Humble","Snake":"Furious","Eagle":"Keen eye","Tortorise":"Slow"]
...
//Clearing out entire dictionary
animal = [:]
if animal.isEmpty
{
...
//ten state names and abbreviations
animal = ["CA":"California","LA":"Los Angeles","AL":"Albama","AS":"Alaska","GA":"Georgia","MA":"Massachusetts","MI":"Michigan","MS":"Mississippi","NJ":"New Jersey","NY":"New York"]

//printing them in this format: `Y: X` where Y is the name of the state and where X is the abbreviation
for (key,value) in animal
{
    print("\(value): \(key)")
}

//Setting first state to nil
animal["CA"] = nil
