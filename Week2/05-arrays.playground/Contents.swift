...
var donuts: [String] = ["Yeast Doughnuts","Cake Doughnuts","Potato Doughnuts","Doughnut Holes","Beignet","Jelly Doughnut"]
var qunatityOfDonuts: [Int] = [1,2,3,4,5,6]

print(donuts)
print(qunatityOfDonuts)

donuts.removeLast()
qunatityOfDonuts.removeLast()

donuts.insert("Boston Cream Doughnut", at: 0)
qunatityOfDonuts.insert(0, at: 0)

print(donuts)
print(qunatityOfDonuts)

donuts.removeAll()
qunatityOfDonuts.removeAll()
