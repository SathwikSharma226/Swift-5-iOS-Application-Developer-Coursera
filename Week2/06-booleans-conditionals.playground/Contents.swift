...
{
    print("The light is Green, keep moving")
}
else if currentLightColor == "Red"
{
    print("The light is Red, stop moving")
}
else if currentLightColor == "Yellow"
{
    print("The light is Yellow, get ready to move")
}
else
{
    print("The signalling system has broken down")
}
